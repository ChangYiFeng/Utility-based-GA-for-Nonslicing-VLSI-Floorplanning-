...
vector<BStarTree*> Crossover(vector<BStarTree*> population, const int kComponentNum, int crossover_type) {
    ...
    if (pci < kProbCrossover){
        ...
        if (crossover_type == 0){
            ...
            // else
            //     kLeftSubtreeCrossover_SuccessCount -= (offspring.back()->area_ - parent_area);
...
BStarTree* Mutation(BStarTree* individual, int mutation_type) {
    ...
    if (pmi < kProbMutation){
        ...
        {
        case 0:
            individual = individual->swapNodeMutation();
            
            // cout << "swap node mutation" << endl;

            // kSwapNode_Count++;

            // new_offspring.push_back(individual->swapNodeMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            // individual->evaluateTotalArea();
            // kEvaluation_count++;

            // if (new_offspring.back()->area_ < individual->area_)
            //     kSwapNode_SuccessCount++;
                // kSwapNode_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            break;

        case 1:
            individual = individual->insertMutation();
            // cout << "insert mutation" << endl;
            // kInsert_Count++;

            // new_offspring.push_back(individual->insertMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            ...
            //     kInsert_SuccessCount++;
                // kInsert_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            break;

        case 2:
            individual = individual->bitwiseMutation();
            // cout << "Bitwise mutation" << endl;
            // kBitwise_Count++;

            // new_offspring.push_back(individual->bitwiseMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kBitwise_SuccessCount++;
                // kBitwise_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            break;

        case 3:
            individual = individual->swapBranchMutation();
            // cout << "scramble mutation" << endl;
            // kScramble_Count++;

            // new_offspring.push_back(individual->scrambleMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kScramble_SuccessCount++;
                // kScramble_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            break;
        case 4:
            individual = individual->scrambleMutation();
            // cout << "swap branch mutation" << endl;
            // kSwapBranch_Count++;

            // new_offspring.push_back(individual->swapBranchMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kSwapBranch_SuccessCount++;
                // kSwapBranch_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            break;

        case 5:
            individual = individual->shiftSubtreeMutation();
            // cout << "shift subtree mutation" << endl;
            // kShiftSubtree_Count++;

            // new_offspring.push_back(individual->shiftSubtreeMutation());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kShiftSubtree_SuccessCount++;
                // kShiftSubtree_SuccessCount += (individual->area_ - new_offspring.back()->area_);
        ...
        case 6:
            int randlevel = rand() % 2;
                if (randlevel)
                    individual = individual->swapSubtreeMutation_sameLevel();
                else
                    individual = individual->swapSubtreeMutation_diffLevel();
            // individual = individual->swapSubtreeMutation_sameLevel();
            // cout << "swap Subtree Mutation_SameLevel" << endl;
            // kSwapSubtree_SameLevel_Count++;

            // new_offspring.push_back(individual->swapSubtreeMutation_sameLevel());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;

            // if (new_offspring.back()->area_ < individual->area_)
            //     kSwapSubtree_SameLevel_SuccessCount++;
                // kSwapSubtree_SameLevel_SuccessCount += (individual->area_ - new_offspring.back()->area_);
        ...
        // case 7:
            ...
            // new_offspring.push_back(individual->swapSubtreeMutation_diffLevel());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kSwapSubtree_DiffLevel_SuccessCount++;
                // kSwapSubtree_DiffLevel_SuccessCount += (individual->area_ - new_offspring.back()->area_);
            
            // break;
        
        // case 8:
            // individual = individual->shuffleSubtreeMutation_sameLevel();
            // cout << "Shuffle Subtree Mutation_SameLevel" << endl;
            // kShuffleSubtree_SameLevel_Count++;

            // new_offspring.push_back(individual->shuffleSubtreeMutation_sameLevel());
            // new_offspring.back()->Mtype_ = mutation_type;
            // new_offspring.back()->evaluateTotalArea();
            // kEvaluation_count++;
            ...
            //     kShuffleSubtree_SameLevel_SuccessCount++;
                // kShuffleSubtree_SameLevel_SuccessCount += (individual->area_ - new_offspring.back()->area_);
        ...
        ;
        // new_offspring.push_back(individual);
    ...
    //     offspring.push_back(new_offspring.at(i));
    // }
    // new_offspring.clear();
    // cout << "offspring num after bit flip: " << offspring.size() << endl;
